...
var G__2166 = format;
var G__2166__$1 = (((G__2166 instanceof cljs.core.Keyword))?G__2166.fqn:null);
switch (G__2166__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__2168 = format;
var G__2168__$1 = (((G__2168 instanceof cljs.core.Keyword))?G__2168.fqn:null);
switch (G__2168__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__2170_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__2170_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__2171){
var map__2172 = p__2171;
var map__2172__$1 = cljs.core.__destructure_map.call(null,map__2172);
var handler = cljs.core.get.call(null,map__2172__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__2172__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__2172__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__2173){
var vec__2174 = p__2173;
var ok = cljs.core.nth.call(null,vec__2174,(0),null);
var result = cljs.core.nth.call(null,vec__2174,(1),null);
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__2177){
var map__2178 = p__2177;
var map__2178__$1 = cljs.core.__destructure_map.call(null,map__2178);
var opts = map__2178__$1;
var method = cljs.core.get.call(null,map__2178__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__2178__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__2178__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__2178__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__2178__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
