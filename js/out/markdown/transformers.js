...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__2439){
var map__2440 = p__2439;
var map__2440__$1 = cljs.core.__destructure_map.call(null,map__2440);
var state = map__2440__$1;
var code = cljs.core.get.call(null,map__2440__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__2440__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__2441 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__2442 = cljs.core.drop.call(null,(2),remaining);
buf = G__2441;
remaining = G__2442;
continue;
} else {
var G__2443 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__2444 = cljs.core.rest.call(null,remaining);
buf = G__2443;
remaining = G__2444;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__2445){
var map__2446 = p__2445;
var map__2446__$1 = cljs.core.__destructure_map.call(null,map__2446);
var state = map__2446__$1;
var buf = cljs.core.get.call(null,map__2446__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.call(null,map__2446__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.call(null,map__2446__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__2446__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.call(null,map__2446__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__2447){
var map__2448 = p__2447;
var map__2448__$1 = cljs.core.__destructure_map.call(null,map__2448);
var state = map__2448__$1;
var code = cljs.core.get.call(null,map__2448__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__2448__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__2450){
var map__2451 = p__2450;
var map__2451__$1 = cljs.core.__destructure_map.call(null,map__2451);
var state = map__2451__$1;
var code = cljs.core.get.call(null,map__2451__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.call(null,map__2451__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__2449_SHARP_){
var vec__2452 = markdown.common.freeze_string.call(null,cljs.core.subs.call(null,p1__2449_SHARP_,(1),(cljs.core.count.call(null,p1__2449_SHARP_) - (1))),cljs.core.deref.call(null,currently_frozen));
var url = cljs.core.nth.call(null,vec__2452,(0),null);
var frozen_strings__$1 = cljs.core.nth.call(null,vec__2452,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2456)].join('');
} else {
return G__2456;
}
});
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__2455_SHARP_){
var encoded = cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,encoder,cljs.core.subs.call(null,p1__2455_SHARP_,(1),(cljs.core.count.call(null,p1__2455_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__2457){
var map__2458 = p__2457;
var map__2458__$1 = cljs.core.__destructure_map.call(null,map__2458);
var state = map__2458__$1;
var inline_heading = cljs.core.get.call(null,map__2458__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__2459){
var map__2460 = p__2459;
var map__2460__$1 = cljs.core.__destructure_map.call(null,map__2460);
var state = map__2460__$1;
var eof = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.call(null,map__2460__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__2461){
var map__2462 = p__2461;
var map__2462__$1 = cljs.core.__destructure_map.call(null,map__2462);
var state = map__2462__$1;
var next_line = cljs.core.get.call(null,map__2462__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.call(null,map__2462__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__5043__auto__ = paragraph;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),(function (){var G__2463 = next_line;
if((G__2463 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__2463);
}
})()));
} else {
return and__5043__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__2464){
var map__2465 = p__2464;
var map__2465__$1 = cljs.core.__destructure_map.call(null,map__2465);
var state = map__2465__$1;
var eof = cljs.core.get.call(null,map__2465__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__2465__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.call(null,map__2465__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__2465__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__2466){
var map__2467 = p__2466;
var map__2467__$1 = cljs.core.__destructure_map.call(null,map__2467);
var state = map__2467__$1;
var codeblock = cljs.core.get.call(null,map__2467__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.call(null,map__2467__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.call(null,map__2467__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.call(null,map__2467__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.call(null,map__2467__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
var next_line_closes_QMARK_ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),(function (){var G__2468 = next_line;
if((G__2468 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__2468);
}
})()));
...
var vec__2469 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,"\n"),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__2469,(0),null);
var code = cljs.core.nth.call(null,vec__2469,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__2472){
var map__2473 = p__2472;
var map__2473__$1 = cljs.core.__destructure_map.call(null,map__2473);
var state = map__2473__$1;
var eof = cljs.core.get.call(null,map__2473__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__2473__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__2473__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__2473__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
if(cljs.core.truth_((function (){var or__5045__auto__ = code;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__2474){
var map__2475 = p__2474;
var map__2475__$1 = cljs.core.__destructure_map.call(null,map__2475);
var state = map__2475__$1;
var blockquote_start = cljs.core.get.call(null,map__2475__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.call(null,map__2475__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.call(null,map__2475__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.call(null,map__2475__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return (function (p1__2476_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__2476_SHARP_),"</ol>"].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__2477){
var vec__2478 = p__2477;
var id = cljs.core.nth.call(null,vec__2478,(0),null);
var label = cljs.core.nth.call(null,vec__2478,(1),null);
...
var vec__2481 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__2481,(0),null);
var key = cljs.core.nth.call(null,vec__2481,(1),null);
var val = cljs.core.nth.call(null,vec__2481,(2),null);
var vec__2484 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__2484,(0),null);
var next_val = cljs.core.nth.call(null,vec__2484,(1),null);
...
var vec__2490 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__2490,(0),null);
var val = cljs.core.nth.call(null,vec__2490,(1),null);
...
var G__2493 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val]));
var G__2494 = cljs.core.rest.call(null,remain);
var G__2495 = key;
acc = G__2493;
remain = G__2494;
prev_key = G__2495;
